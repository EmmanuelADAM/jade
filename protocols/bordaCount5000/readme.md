...
Here you will find an example of communication via the [FIPA Contract Net](http://www.fipa.org/specs/fipa00029/SC00029H.html) protocol  for a "Borda" count for a vote :   
**5000 voters** rank the options by rating them, a sum of the notes is then made.

Here the participants do not have a window, but just dipsplay the result of the vote in the console.
