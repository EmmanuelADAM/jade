...
- Des classes sont déjà proposées : 
    ...
    - La classe [LaunchSimu](https://github.com/EmmanuelADAM/jade/blob/master/agentsVoyage/launch/LaunchSimu.java) lance un client, 3 agencesVoyages.agents agence de voyages spécialisée, et 1 agent d'alertes.
