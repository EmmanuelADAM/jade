package td.negoHumanAgents.launch;
...
public class LaunchAgents {
    public static void main(String[] args) {
        ...
        // -- add the agents
        StringBuilder sb = new StringBuilder("a:td.negoHumanAgents.agents.SellerAgent;");
        for (int i = 1; i < 10; i++)
            sb.append("sim_").append(i).append(":td.negoHumanAgents.agents.BuyerAgent;");
