package td.negociationWindowSolution;
...
public class Main  {
    ...
    public static void main(String[] args) {
        ...
        // declare the agents
        prop.setProperty(Profile.AGENTS, "buyer:td.negociationWindowSolution.agents.BuyerAgent;seller:td.negociationWindowSolution.agents.SellerAgent");
