...
import td.negociationWindowSolution.gui.GuiSellerAgent;
...
public class SellerAgent  extends GuiAgent {
    ...
    private void sendFirstMessage() {
        ...
        proposedPrice = Double.parseDouble(window.jtfInitialPrice.getText());
        // at the end, p <- initial price * r^maxRounds
